...
class FileDB extends Database {
  ...
  validateQuestion(question) {
    ...
    if(!this.allowLongAnswers && typeof question.incorrect_answers === "object") {
      var answer;
      for(var i = 0; i <= 3; i++) {
        ...
        if(typeof token !== "undefined") {
          ...
          if(typeof options.type !== "undefined" || typeof options.difficulty !== "undefined") {
            exclusionPool.forEach((el) => {
              el.type = '';
              if(typeof el.incorrect_answers !== "undefined") {
              ...
              else if(typeof options.type !== "undefined" && (el.type == '' || el.type !=='' && el.type !== options.type)) {
                exclusionArray.push(el.id);
              }
            });
          }
