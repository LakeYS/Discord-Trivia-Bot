import { TriviaDiscord } from "../platform/discord_main.js";
...
export default (Trivia) => {
  /**
   * @param {TriviaInteraction} interactionHelper The interaction handler.
   * @param {boolean} isPong Respond with 'Pong'?
   */
  return function doTriviaPing(interactionHelper, isPong) {
    ...
    interactionHelper.maybeReply({content: str});
  };
};