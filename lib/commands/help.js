...
module.exports = (config) => {
  ...
  return async function(msg, Database) {
    ...
    // Commands and links
    const stringContribute = "\n([Support TriviaBot on Patreon](https://www.patreon.com/LakeYS)) ([Contribute questions to the database](http://lakeys.net/triviabot/contribute))";
    ...
    \n\
    \n_Bot by [Lake Y](http://lakeys.net). Powered by discord.js ${pjson.dependencies["discord.js"].replace("^","")}` +
    `${config.databaseURL==="https://opentdb.com"?` and the [Open Trivia Database](https://opentdb.com/).${stringContribute}`:""}_`;
