...
module.exports = (Trivia) => {
  ...
  async function parseAdvCommandArgs(channel, author, reply, replyDirect, argsObject) {
    ...
    const categoryRaw = argsObject.getString("category");
    ...
    const data = {
      ...
      categoryInput,
      type: typeIndex[argsObject.getString("type")],
      difficulty: difficultyIndex[argsObject.getString("difficulty")],
      channel: argsObject.getChannel("channel").id // TODO Pass this direct so we don't have to re-acquire it.
    };
