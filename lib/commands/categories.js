module.exports = () => {
  return async function(interactionHelper, isDM, Trivia) {
    var json;
    var json2;
    ...
    try {
      ...
      interactionHelper.maybeReply({embed: {
        color: 14164000,
        description: "Failed to get the list of categories: An internal " +
        "error occurred."
      }});
    ...
    interactionHelper.maybeReply(categoryListStr, {direct: true});
  };
};
