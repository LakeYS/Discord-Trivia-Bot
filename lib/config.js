...
module.exports = (configFile, displayWarnings) => {
  ...
  config["beta-authorized-count"] = config["beta-authorized-count"] || 1;
  // NOTE: The following option currently only works properly on Windows.
  config["beta-reset-timer"] = config["beta-reset-timer"] || -1; // 900000 = 15 min
