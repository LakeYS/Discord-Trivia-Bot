...
class Game extends EventEmitter {
  ...
  validateGame() {
    ...
    if(typeof this.timeout !== "undefined" && this.timeout._idleTimeout === -1) {
  ...
  async endRound() {
    ...
    if(this.getConfig("reveal-answers") === true) { // DELTA: Answers will be not shown in the Summary
      answerStr = `${this.gameMode!==2?`**${Letters[this.question.displayCorrectID]}:** `:""}${this.Trivia.formatStr(this.question.answer)}\n\n`;
    }
