...
class Game extends EventEmitter {
  ...
  async initializeRound() {
    ...
    try {
      // TODO: Token support is disabled.
      question = await this.Trivia.getTriviaQuestion(0, void 0, 0, this.question.isFirst, this.options.category, this.options.type, this.options.difficulty);
    ...
    this.timeout = setTimeout(() => {
      this.Trivia.doAnswerReveal(this, this.question.answer);
    }, this.getConfig("round-length"));

    this.emit("round_initialize", this, finalString);
    return finalString;
  }
