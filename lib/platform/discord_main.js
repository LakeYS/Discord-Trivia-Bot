...
Trivia.gameHandler.on("game_create", async (game) => {
...
commands.triviaHelp = require("../commands/help.js")(Config, Trivia, client);
...
Trivia.postStats = async () => {
  var listings = new Listings(global.client.user.id, global.client.shard.ids);
