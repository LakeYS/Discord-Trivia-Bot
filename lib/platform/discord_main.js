...
class TriviaDiscord extends TriviaInstance {
  ...
  parseAnswer(game, interaction, str, channelId, userId, username) {
    if(!game.inRound) {
  ...
  buttonPress(interaction, answer, userId, username) {
    ...
    this.parseAnswer(game, interaction, answer, id, userId, username, this.getConfig("score-value", interaction.message.channel));
