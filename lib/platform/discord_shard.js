...
var Trivia = global.client.Trivia = require("./discord_main.js");
...
if(typeof Config.additional_packages !== "undefined") {
  Config.additional_packages.forEach((key) => {
    require(key)(Trivia);
  });
}
...
global.client.on("guildCreate", () => {
  if(!Config.stat_guild_recording) {
    return;
  }
