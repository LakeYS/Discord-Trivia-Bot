...
if(!config["fallback-intents"]) {
  intents.push(GatewayIntentBits.GuildMessages, GatewayIntentBits.DirectMessages, GatewayIntentBits.MessageContent);
}
...
client.on("interactionCreate", async interaction => {
    ...
    Trivia.doCommand(interaction.commandName, reply, interaction.channel, interaction.member);
  }
});
