...
module.exports = (input) => {
  ...
  OpenTDB.getToken = (tokenChannelID) =>  {
    return new Promise((resolve, reject) => {
  ...
  // initCategories
  // Initializes or re-initializes OpenTDB.categories
  OpenTDB.initCategories = () => {
    // Initialize the categories
    return new Promise((resolve, reject) => {
      parseURL(config.databaseURL + "/api_category.php")
      .then((data) => {
        OpenTDB.categories = data.trivia_categories;
  ...
  // resetTriviaToken
  OpenTDB.resetTriviaToken = (token) => {
    return new Promise((resolve, reject) => {
