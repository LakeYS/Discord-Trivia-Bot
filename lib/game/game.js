...
class Game extends EventEmitter {
   ...
   * 
   * @param {*} [endStr] - The message to end the game with.
   */
  ...
  async endRound(isForced, endStr) {
    ...
    var str = this.gameStrings.buildRoundEndStr(this, gameIsEnding, isForced, endStr);

    // Finalization
    if(gameIsEnding) {
      this.emit("round_end", { roundTimeout, gameIsEnding});
      this.endGame(str);
      return;
    }
    else {
