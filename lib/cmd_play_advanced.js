...
module.exports = (Trivia, client) => {
  function getAdvStr(identifier, data) {
    switch(identifier) {
      ...
      case "category":
        return "Type the category you would like to play in. Type \"random\" or \"r\" to play in random categories. Type \"trivia categories\" to see a list of available categories.";
