  ...
  function triviaPlayAdvanced(onGameStart, id, channel, author) {
    if(typeof advData[id] === "undefined") {
      Trivia.send(channel, author, {embed: {
        ...
        description: "Type the category you would like to play in. Type \"random\" or \"r\" to play in random categories. Type \"trivia categories\" to see a list of available categories.",
